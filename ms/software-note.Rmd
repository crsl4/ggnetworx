...
```{r, echo=FALSE}
## https://yulab-smu.github.io/treedata-book/chapter4.html#visualizing-phylogenetic-tree-with-ggtree
library(phangorn)
...
p4 = ggevonet(whalesnet,layout = "slanted") +
    ...
    geom_tiplab(aes(image=paste0('figures/',label, '.png')), geom="image",
                offset=1.5, align=2, size=.15)+
    geom_tiplab(geom='label', offset=0.5, hjust=.1)+
    geom_hilight(node=22)
```
